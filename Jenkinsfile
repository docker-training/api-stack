    ...
    stages {
        stage('Build') {
            ...
            steps {
                ...
                sh 'docker image build --target test -t ${DTR_FQDN_PORT}/engineering/api:unittest-1.0-build-${BUILD_ID} api'
                ...
                sh 'docker image push ${DTR_FQDN_PORT}/engineering/api:unittest-1.0-build-${BUILD_ID}'
            }
        }
    }
}
