        ...
        stage('Build') {
            ...
            steps {
                script {
                    ...
                    docker image build --target test -t ${DTR_FQDN_PORT}/engineering/api:unittest-1.0-build-${BUILD_ID} api
                    ...
                    docker image push ${DTR_FQDN_PORT}/engineering/api:unittest-1.0-build-${BUILD_ID}
                }
            }
        }
    }
